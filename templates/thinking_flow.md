...
| 近5年净利中枢 vs 前5年 变化>100% | 盈利 regime 切换，PE/PB 区间必须只用切换后年份或手动指定（见 growth_params 第八节） |
...
**真实案例（2026-08 复盘）**：
- **中远海控**：行业是航运（cyclical 直觉），但实际已进化为"高股息央企价值股"——2025-2027 分红承诺 30-50%、股息率 6.5%、现金 1508 亿、长协收入占比 70%。用 cyclical 的 10 年 PE 区间（0.9-7.2，被 2020-2022 暴利年拉低）导致常态盈利下 PE 恒超 90th，近两年 74% 交易日被误判"高估"。改用 soe + 校准区间（PE 4-12）后恢复正常。
